...
class CompositeStringMultiMapTest {
    ...
    void getAll() {
        ...
        assertThat(headers.getAll("k2")).isEqualTo(ImmutableList.of("v2", "v3"));
        assertThat(headers.getAll("k3")).isEqualTo(ImmutableList.of("v4", "v5", "v6"));
    ...
    void contains() {
        ...
        assertThat(headers.containsTimeMillis("k1", 1000L)).isTrue();
    }
    ...
    void isEmpty() {
        ...
        final CompositeStringMultimap<CharSequence, AsciiString> empty5 = new CompositeHttpHeadersBase(HttpHeaders.of(),
                                                                                                       HttpHeaders.of(),
                                                                                                       HttpHeaders.builder()
                                                                                                                  .add("k1",
                                                                                                                       "v1")
                                                                                                       ...
                                                                                                       HttpHeaders.builder()
                                                                                                                  ...
                                                                                                                  .build(),
                                                                                                       HttpHeaders.of());
        assertThat(empty5.isEmpty()).isTrue();
        assertThat(empty5.size()).isZero();
        assertThat(empty5.get("not_exist")).isNull();
        assertThat(empty5.names()).isEmpty();
    }
    ...
    void forEach() {
        final CompositeStringMultimap<CharSequence, AsciiString> headers =
                new CompositeHttpHeadersBase(HttpHeaders.of(),
                                             ...
                                             HttpHeaders.of());
        final ImmutableList.Builder<Entry<AsciiString, String>> builder = ImmutableList.builder();
        headers.forEach((k, v) -> builder.add(new SimpleEntry<>(k, v)));
    ...
    void forEachValue() {
        ...
        headers.forEachValue("k1", builder::add);
